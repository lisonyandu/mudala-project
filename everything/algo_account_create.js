...
console.log(
  'Account created. Note the address and mnemonic (store mnemonic somewhere safe!)'
);
...
console.log('');
console.log(
  'Add funds to all of these accounts using the TestNet Dispenser at https://bank.testnet.algorand.network/ (if accounts are created on testnet)'
);
console.log(
  'Alternatively, add funds to all of these accounts using goal (i.e. ./sandbox goal clerk send -a 12345678)  using one of the default accounts created from the unencrypted wallet'
);
console.log('');
console.log(
  'Copy these 3 lines of code. They will be used in the tutorials that follow (algo_account_balance.js and algo_account_send.js'
);
console.log('');
...
// Account 1 = U5GKWLFAPRXT6JC7DYKXPJNBZXUYBKJGTZL3TO5F77ZYAYPM4CI4G2T2CE
// Account Mnemonic 1 = mesh enemy swarm oyster same foil kangaroo across biology inflict remain electric angry destroy office solid parade labor place vital link coil flavor abstract convince
// Account created. Note the address and mnemonic (store mnemonic somewhere safe!)
// Account 2 = ZU4XCK7UQZRINETS7BCBFD4DC6UAKFJQ2VFYJHW7FW5G7TY4TJDCYOKUNU
// Account Mnemonic 2 = renew census border ethics fragile photo amused alone risk shop exercise aware slide chunk illness slide valid joy album culture evolve moral pretty about fantasy
// Account created. Note the address and mnemonic (store mnemonic somewhere safe!)
// Account 3 = CK6IKHX2YTKF372EM653WSR4OOWN3BZLVBETXQEZV6TNE3HC5QF3MZ7RZA
// Account Mnemonic 3 = busy zebra follow brand fire victory honey addict simple spot final garbage young critic monitor buffalo muffin sting hour ticket aunt elbow slow absorb pipe
